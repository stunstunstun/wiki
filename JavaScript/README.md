...
### Testing
- JavaScript의 Testing 환경
- Jest로 시작하기 w/__tests__, __mocks__, setup, teardown, describe, test, expect
- `supertest`를 통한 API 통합 Testing w/fixtures
- 비동기 Testing 하기
- Enzyme, Jest Snapshot Testing을 통한 React Component 테스트
- React와 Storybook을 통한 Interactive UI Dev and Testing
- Redux actions, reducers Testing 하기
- Coverage 리포트 생성하고 지속적으로 배포하기
